...
function load_Scripts() {
    ...
    wp_enqueue_script('init', get_template_directory_uri() . '/js/cc_init.js', array('jquery'), '1.0', true );

    // Lade CSS
    wp_register_style('global', get_template_directory_uri() . '/less/all.less', array() , false, 'all' );
